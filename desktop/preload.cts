...
const api: DesktopApi = {
  ...
  inspectWorkspaceExtensions: (workspace) => ipcRenderer.invoke(CHANNELS.inspectWorkspaceExtensions, workspace),
  ...
  openProviderSetup: (request) => ipcRenderer.invoke(CHANNELS.openProviderSetup, request),
  ...
  openLatestRelease: () => ipcRenderer.invoke(CHANNELS.openLatestRelease),
