...
const PUBLIC_UPDATE_ROOT = `https://github.com/${PUBLIC_GITHUB_REPOSITORY}/releases/latest/download`;
...
export function resolveDesktopUpdateFeed(input: {
  ...
  if (input.arch !== "x64") throw new Error("Windows update architecture is unsupported");
  return PUBLIC_UPDATE_ROOT;
}
