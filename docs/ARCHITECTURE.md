...
> **状态基线**：2026-08-17，`v0.12.5 / Public Bug Reporting + Product Truth` 是当前公开但未签名的 Engineering Alpha Release，并继续包含 M11.1 Goal Contract + Plan Review、M12.1-M12.4 与公开更新桥接。各历史 Validation 保留对应阶段当时的证据边界。
