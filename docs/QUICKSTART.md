...
> 适用版本：当前私有 Release `v0.12.2 / Windows Canary + Safe Updates`。当前灰度与发布优先 Windows；macOS 保留回归，Linux 降为维护。开始前先阅读 [`KNOWN-LIMITATIONS.md`](KNOWN-LIMITATIONS.md)。
...
| Windows x64 | 使用私有 [`v0.12.2` Release](https://github.com/LLM-X-Factorer/diantou-localbuddy-v2/releases/tag/v0.12.2) 的 Setup/ZIP | Release Runner 已完成合同、无凭据首启、Plan Review 合成灰度、`v0.12.1 -> v0.12.2` 原地升级/profile 保留和卸载；终端用户设备仍待验收 |
