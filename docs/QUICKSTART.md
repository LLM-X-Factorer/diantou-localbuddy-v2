...
> 适用版本：当前公开但未签名的 Engineering Alpha Release `v0.12.7 / Real-user Update + One-consent Reporting`。当前灰度与发布优先 Windows；macOS 保留回归，Linux 降为维护。开始前先阅读 [`KNOWN-LIMITATIONS.md`](KNOWN-LIMITATIONS.md)。
